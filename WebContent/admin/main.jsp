...
<body>
	<div id="header">
		<h1 style="margin-left: 0px;padding-left: 0px;"><a href="#">CooodIng</a></h1>	
		<!-- <h2 style="padding: 0px; margin-top: 10px; margin-bottom: 0px;">
			<a href="#"><font color="#cccccc">CooodIng论坛</font></a>
		</h2>
	...
	<div id="content">
		...
		<div class="row-fluid">
			<div id="footer" class="span12">
				2018 &copy; CooodIng. 作者：HMZQYL&nbsp;&nbsp;&nbsp;&nbsp; <a href="https://www.CooodIng.com">CooodIng知识分享网</a>
			</div>
		</div>
	</div>
